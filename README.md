...
The idea came from everyday frustration — having to touch garbage can lids in shared spaces, especially in labs or kitchens where hygiene matters. I wanted to design a low-cost, motion-sensing trash can that automatically opens and closes its lid when someone approaches, eliminating the need for contact while maintaining reliability and affordability.
...
-Servo actuation with PWM-based motion control

-Event-driven firmware design for real-time responsiveness

-Iterative cost and performance optimization (25% reduction in materials)
...
-<b>Reliability</b>: Quick, consistent detection and lid movement

-<b>Efficiency</b>: Low power draw and component simplicity

-<b>Affordability</b>: Use of widely available, inexpensive components
